	...
	$(function(){
		$.post("<c:url value='/dashboard/getregion'/>", function(data)
		{
			...
			alert("data : " + data[0].REG_NAME);
				...
				eval("jsonObj="+text.value);
				alert("6");;

				jsonDisplay(div, data);
...
<!--// foot -->
<div id="jsontable">hhhhhhhhhhhhhhhhhhhhhhhhhh</div>
</body>
</html>